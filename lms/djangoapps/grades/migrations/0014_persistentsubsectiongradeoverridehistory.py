    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.CharField(choices=[(b'PROCTORING', b'Proctoring'), (b'GRADEBOOK', b'Gradebook')], default=b'PROCTORING', max_length=10)),
                ('action', models.CharField(choices=[(b'CREATEORUPDATE', b'Create_or_update'), (b'DELETE', b'Delete')], default=b'CREATEORUPDATE', max_length=14)),
